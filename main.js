...
// }
global.authFile = `${opts._[0] || 'jevin'}.data.json`
...
async function connectionUpdate(update) {
  ...
  if (update.receivedPendingNotifications) conn.sendMessage(`6281210283436@s.whatsapp.net`, {text: 'Successfully connected by jevin' }) 
}
